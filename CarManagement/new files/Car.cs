...
namespace CarManagement.Models
{
    public class Car
    {
        ...
        public ManufacturerClass Manufacturer { get; set; }  // Navigation Property

        [Required]
        public int TypeId { get; set; }  // Foreign Key

        [ForeignKey("TypeId")]
        public CarTypeClass CarType { get; set; }  // Navigation Property
        ...
        public CarTransmissionTypeClass TransmissionType { get; set; }  // Navigation Property
