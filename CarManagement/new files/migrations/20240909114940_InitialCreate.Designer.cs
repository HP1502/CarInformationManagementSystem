...
namespace CarManagement.Migrations
{
    ...
    [Migration("20240909114940_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarManagement.Models.Car", b =>
                {
                    b.HasOne("CarManagement.Models.ManufacturerClass", "Manufacturer")
                        .WithMany()
                        .HasForeignKey("ManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarManagement.Models.CarTransmissionTypeClass", "TransmissionType")
                        .WithMany()
                        .HasForeignKey("TransmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarManagement.Models.CarTypeClass", "CarType")
                        .WithMany()
